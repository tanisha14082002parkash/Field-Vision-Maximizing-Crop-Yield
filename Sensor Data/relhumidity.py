# -*- coding: utf-8 -*-
"""
Created on Mon Apr 24 17:50:29 2023
...
df
df['Relative_Humidity'] = df['Relative_Humidity'].ffill()
df= pd.to_numeric(df['Relative_Humidity'], errors='coerce')
...
relhumidity = df.to_csv('rh.csv', index = True)

df.plot()


training_set = df.iloc[:542].values
test_set = df.iloc[542:].values
